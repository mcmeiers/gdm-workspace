...
CLASS_PATH = "/home/mmeiers/Projects/gdm-cosmology/code/my-class"  # COBAYA_PACKAGES_PATH / "code/class_public-designer/"
...
lcdm_params = {
    ...
    "Omega_gdm_max": {
        "value": max(
            get_CLASS_background()["(.)rho_gdm"]
            / get_CLASS_background()["H [1/Mpc]"] ** 2
        )
    },
}
