...
w_range_filter = ((-14, {'min': -1, 'max': 1 / 3.}),
                  (-7, {'min': -1, 'max': 1}),
                  (-2, {'min': 1 / 3, 'max': 1}))
...
lcdm_params = {'logA': {'prior': {'min': 1.61, 'max': 3.91},
...
cobaya_info = dict(theory={'classy': {'extra_args': {**gdm_model.fixed_settings,
                                                     'non_linear': 'hmcode',
                                                     'l_max_scalars': 5000},
                                       'path': str(CLASS_PATH)}},
                    params={**lcdm_params,
